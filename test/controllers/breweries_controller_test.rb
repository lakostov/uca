...
class BreweriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post breweries_url, params: { brewery: { city: @brewery.city, name: @brewery.name, state: @brewery.state } }
    end
  ...
  test "should update brewery" do
    patch brewery_url(@brewery), params: { brewery: { city: @brewery.city, name: @brewery.name, state: @brewery.state } }
